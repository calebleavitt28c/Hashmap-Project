...
private:
	Node** hashArray;	// holds the node pointers for the chained linked list of Nodes
	int sizeOfArray;

	int GenerateHash(string key) const; // converts the key to a value used to index into the array
};
